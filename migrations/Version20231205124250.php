 ...
 */
final class Version20231205124250 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE skill (id INT AUTO_INCREMENT NOT NULL, barre_de_talent_id INT NOT NULL, title VARCHAR(70) NOT NULL, is_completed TINYINT(1) NOT NULL, INDEX IDX_5E3DE4771D69D61D (barre_de_talent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE talent (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, pourcentage DOUBLE PRECISION DEFAULT NULL, color VARCHAR(7) NOT NULL, UNIQUE INDEX UNIQ_16D902F52B36786B (title), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
